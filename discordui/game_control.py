...
class NewGameView(discord.ui.View):
    ...
    class JoinGameButton(discord.ui.Button):
        def __init__(self):
            super().__init__(label="Join The Game", style=discord.ButtonStyle.primary, emoji="🤝")
        ...
        async def callback(self, interaction: discord.Interaction):
            try:
                ...
                await interaction.followup.send("You cannot interact with this button at the time.", ephemeral=True)


    class StartGameButton(discord.ui.Button):
        def __init__(self):
            super().__init__(label="Game Start", style=discord.ButtonStyle.success, emoji="🚀")
